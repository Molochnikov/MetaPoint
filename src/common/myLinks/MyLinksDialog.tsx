...
let strings: IMyLinksStrings = 
  {
    "DialogSaveButton": "Сохранить",
    "DialogCancelButton": "Отмена",
    "DialogAddButton": "Добавить",
    "DialogUpdateButton": "Изменить",

    "MyLinksDialogTitle": "Ссылки",
    "MyLinksDialogDescription": "Используйте этот диалог для изменения ссылок",
    "SingleLinkDialogTitle": "Добавить/изменить ссылку",
    "SingleLinkDialogDescription": "Используйте этот диалог для изменения ссылки",
    "ConfirmDeleteLink": "Вы действительно хотите удалить ссылку?",

    "LinkTitleLabel": "Текст",
    "LinkUrlLabel": "Адрес",
    "InvalidUrlError": "Введённый адрес не допустимый",

    "TitleColumn": "Текст",
    "TitleColumnAriaLabel": "Текст ссылки",
    "UrlColumn": "Адрес",
    "UrlColumnAriaLabel": "Адрес ссылки",
    "SelectionColumnAriaLabel": "Переключить выбор",
    "SelectionAllColumnAriaLabel": "Переключить выбор для всех",
    
    "AddLinkCommand": "Добавить",
    "EditLinkCommand": "Изменить",
    "DeleteLinkCommand": "Удалить"
